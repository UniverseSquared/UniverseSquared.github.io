...
function __wbg_adapter_16(arg0, arg1) {
    _assertNum(arg0);
    _assertNum(arg1);
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfe37387e221e3a6f(arg0, arg1);
}

/**
* @returns {any}
*/
export function list_examples() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.list_examples(retptr);
...
*/
export function load_binary_file(bytes) {
    wasm.load_binary_file(addHeapObject(bytes));
}

/**
* @param {string} source
*/
export function assemble_into_memory(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.assemble_into_memory(ptr0, len0);
}

/**
* @param {KeyboardEvent} event
*/
export function keyboard_event(event) {
    wasm.keyboard_event(addHeapObject(event));
}

/**
*/
export function exec_instruction() {
    wasm.exec_instruction();
}

/**
*/
export function reset_cpu() {
    wasm.reset_cpu();
}
...
function getImports() {
    ...
    imports.wbg.__wbg_alert_1fd0ed17e8a2df1c = function() { return handleError(function (arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg_instanceof_HtmlButtonElement_173e1d7a3882bdf2 = function() { return logError(function (arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_setdisabled_2387ac431b494f24 = function() { return logError(function (arg0, arg1) {
    ...
    imports.wbg.__wbg_setonclick_361e8684743f7de8 = function() { return logError(function (arg0, arg1) {
        getObject(arg0).onclick = getObject(arg1);
    }, arguments) };
    imports.wbg.__wbg_log_4b5638ad60bdc54a = function() { return logError(function (arg0) {
    ...
    imports.wbg.__wbindgen_closure_wrapper333 = function() { return logError(function (arg0, arg1, arg2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sprkl4_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
